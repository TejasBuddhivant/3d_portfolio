...
import { glassTints } from "@/components/ui";

const DRAWER_WIDTH = 280;

// Module-level constant: a fresh inline array would re-key the scroll-spy
// effect on every render and tear its IntersectionObserver down constantly.
...
export default function Navbar() {
  ...
  // Keep the navbar indicator in sync with the section in view. The pathname
  // re-attaches the observer after route changes, when the sections remount.
  useActiveSection(SECTION_IDS, pathname);
